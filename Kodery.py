...
class Kodery(sublime_plugin.EventListener):
    ...
    def thread_finished(thread):
        ...
        for snippet in snippets:
            ...
            for fragment in snippet['fragments']:
                ...
                completions.append({
                    'name': prefix + truncate(fragment['name'], 22),
    ...
    def on_query_completions(self, view, prefix, locations):
        ...
        for completion in Kodery.completions:
            ...
            if (completion['fragment_name'].startswith(prefix) or
                completion['snippet_name'].startswith(prefix)):
